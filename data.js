...
window.DATA = {
  ...
  notes: {
    ...
    arts: "Storm King is five miles away; Dia Beacon and the Cold Spring galleries are a bridge crossing east.",
  ...
  arts: [
    ...
    { name: "Dia Beacon", town: "Beacon", kind: "Museum", lat: 41.5006, lon: -73.9740,
    ...
    { name: "Magazzino Italian Art", town: "Cold Spring", kind: "Museum", lat: 41.4097, lon: -73.9520,
    ...
    { name: "Newburgh Brewing Company", town: "Newburgh", kind: "Music & taproom", lat: 41.4993, lon: -74.0122,
    ...
    { name: "Ann Street Gallery", town: "Newburgh", kind: "Gallery", lat: 41.5034, lon: -74.0120,
    ...
    { name: "Towne Crier Cafe", town: "Beacon", kind: "Music venue", lat: 41.5050, lon: -73.9690,
    ...
    { name: "Paramount Hudson Valley", town: "Peekskill", kind: "Theater", lat: 41.2897, lon: -73.9210,
    ...
    { name: "Bardavon 1869 Opera House", town: "Poughkeepsie", kind: "Theater", lat: 41.7060, lon: -73.9370,
